...
import 'package:flutter/services.dart'; // FilteringTextInputFormatter 사용을 위해 추가
...
class _JoinScreenState extends State<JoinScreen> {
  ...
  final config = CalendarDatePicker2Config(
    ...
    // 선택한 날짜 색상
    selectedDayHighlightColor: Colors.lightGreen[900],
    // 요일 라벨
              ...
              child: Column(
                children: [
                  ...
                  DropdownButtonFormField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          _idType = value!; // 변수! : null 이 아님을 명시
                        });
                      }),
                  const SizedBox(
                    height: 20,
                  ...
                  TextField(
                    ...
                    onChanged: (value) {
                      ...
                      // iint.tryParse("숫자가 아닌문자열 || 빈 문자열") : 예외 대신 null 로 반환
