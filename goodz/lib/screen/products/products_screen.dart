...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  Widget productContainer({required int pNo, required String productName, required int price, required String imgUrl}) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 15), // Increased vertical padding
      color: Color.fromARGB(111, 199, 199, 199),
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 0, vertical: 0), // Padding above the price
            child: Text(
              "${price.toString()} 원",
              style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold), // Adjust fontSize or weight if needed
            ),
          ),
        ],
      ),
